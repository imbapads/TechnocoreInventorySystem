...
public class UIC {
        ...
        public static void showClock(javax.swing.JLabel lblTimestamp){
            Thread clock = new Thread(){
                public void run(){
                    try{
                        while(true){
                            String timestamp = UIC.Date.getCurrentTimeStamp();
    ...
    public static class Report{
        public static void viewReport(String InStockReport){
            try{
                net.sf.jasperreports.engine.design.JasperDesign jasperDesign = net.sf.jasperreports.engine.xml.JRXmlLoader.load(InStockReport);
                ...
                net.sf.jasperreports.engine.JasperPrint jasperPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport(jasperReport, null, SQLiteInStock.conn);
                net.sf.jasperreports.view.JasperViewer.viewReport(jasperPrint, false);             
            }catch(Exception e){
                System.out.println("iReport Error: " + e.getMessage());
            }    
        }
         public static void viewReport(InputStream file){
            try{
                net.sf.jasperreports.engine.design.JasperDesign jasperDesign = net.sf.jasperreports.engine.xml.JRXmlLoader.load(file);
                net.sf.jasperreports.engine.JasperReport jasperReport = net.sf.jasperreports.engine.JasperCompileManager.compileReport(jasperDesign);
                net.sf.jasperreports.engine.JasperPrint jasperPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport(jasperReport, null,SQLiteInStock.conn);
                net.sf.jasperreports.view.JasperViewer.viewReport(jasperPrint, false);             
            }catch(Exception e){
        ...
        public static void viewReport(javax.swing.JScrollPane jspReport, String InStockReport){            
            try{
                java.util.HashMap parameter = new java.util.HashMap();
                java.io.File reportFile = new java.io.File(InStockReport);          
                ...
                net.sf.jasperreports.engine.JasperPrint jPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport(jReport, parameter, SQLiteInStock.conn);
        ...
        public static void viewReport2(String InStockReport){
            try{
                net.sf.jasperreports.engine.design.JasperDesign jasperDesign = net.sf.jasperreports.engine.xml.JRXmlLoader.load(InStockReport);
                net.sf.jasperreports.engine.JasperReport jasperReport = net.sf.jasperreports.engine.JasperCompileManager.compileReport(jasperDesign);
         ...
         public static void viewReport2(InputStream file){
            try{
                net.sf.jasperreports.engine.design.JasperDesign jasperDesign = net.sf.jasperreports.engine.xml.JRXmlLoader.load(file);
                net.sf.jasperreports.engine.JasperReport jasperReport = net.sf.jasperreports.engine.JasperCompileManager.compileReport(jasperDesign);
                net.sf.jasperreports.engine.JasperPrint jasperPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport(jasperReport, null,SQLite.conn);
        ...
        public static void viewReport2(javax.swing.JScrollPane jspReport, String InStockReport){            
            try{
                java.util.HashMap parameter = new java.util.HashMap();
                java.io.File reportFile = new java.io.File(InStockReport);          
